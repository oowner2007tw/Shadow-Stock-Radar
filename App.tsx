                        ...
                        <table className="w-full text-left border-collapse">
                          ...
                          <tbody className="divide-y divide-slate-800 text-slate-300 text-sm">
                            <tr className="hover:bg-slate-800/50 transition-colors">
                              ...
                              <td className="p-4 text-slate-400">即時檢索 VIX、加權季線乖離、<b>加權大盤融資餘額</b>、三大法人買賣超等 8 大關鍵指標。</td>
                            </tr>
                            <tr className="hover:bg-slate-800/50 transition-colors">
                              <td className="p-4 font-bold text-white">Decision Logic (決策層)</td>
                              <td className="p-4">Bias Injection & Threshold</td>
                              {/* 修正 TS1382: 使用 {'>'} 與 {'<'} 避免標籤解析錯誤 */}
                ...
                <div className="animate-fade-in space-y-6 pb-12 print:pb-0">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 print:grid-cols-4">
                    <div className="bg-slate-900 p-5 rounded-xl border border-slate-800 shadow-lg print:bg-white print:text-black">
                      <div className="text-slate-400 text-xs uppercase">Stock Symbol</div>
